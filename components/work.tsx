      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div>
            ...
            >
              Real results we have delivered for SaaS and high-tech clients.
            </motion.p>
          </div>
          <motion.button
                  ...
                  <div className={`p-12 flex flex-col justify-center relative overflow-hidden`}>
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-white/70 mb-8 max-w-md">
                        Driving measurable growth through strategic marketing campaigns and data-driven optimization.
                      </p>
                      <div className="flex items-center gap-4 text-sm font-medium">
                        <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10">Paid Media</span>
                        <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10">SEO & CRO</span>
                      </div>
                    </div>
                  </div>
