  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8">
            ...
            <span className="text-xs font-medium text-white/80 uppercase tracking-wider">
              SaaS & High-Tech Marketing Experts
            </span>
          </div>
        </motion.div>
        ...
        >
          We help SaaS and high-tech companies scale with data-driven online marketing. 
          Performance campaigns, SEO, and growth strategies built for results.
        </motion.p>
        ...
        >
          <button className="group relative px-8 py-4 bg-white text-black rounded-full font-semibold text-lg overflow-hidden transition-all hover:scale-105">
            <span className="relative z-10 flex items-center gap-2">
              See Our Results <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </span>
